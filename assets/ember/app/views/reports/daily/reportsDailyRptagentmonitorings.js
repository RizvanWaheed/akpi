...
telenor.ReportsDailyRptagentmonitoringsView = Ember.View.extend(telenor.AnimateView, { //telenor.MainView.extend({ 
	templateName: 'reports/daily/rptagentmonitorings',
	didInsertElement: function(){
		 var date = new Date();
	    var today = new Date(date.getFullYear(), date.getMonth(), date.getDate());
	    var end = new Date(date.getFullYear(), date.getMonth(), date.getDate());
        Ember.$('#dateAgentAttendenceReportDaily').datepicker({
        ...
        Ember.$('#dateAgentAttendenceReportDaily').datepicker('setDate', today);

        /*Ember.$('#dateAgentAttendenceReportHourly').datepicker({
           format: "mm/dd/yyyy",//MM/DD/YYYY
           endDate: today,
          // startDate: today,
           todayHighlight: true,
        ...
        Ember.$('#dateAgentAttendenceReportHourly').datepicker('setDate', today);

        Ember.$('#dateAgentAttendenceReportLoginLogout').datepicker({
           format: "mm/dd/yyyy",//MM/DD/YYYY
           endDate: today,
          // startDate: today,
           todayHighlight: true,
        ...
        Ember.$('#dateAgentAttendenceReportLoginLogout').datepicker('setDate', today);*/
