telenor.QualityRendomizingsController = Ember.ArrayController.extend({
	pageName:'qualityRendomizings',
...
telenor.RendomizingController = Ember.ObjectController.extend({
	need:['rendomizings'],
