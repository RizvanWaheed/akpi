telenor.QualityScMonitoringsController = Ember.ArrayController.extend({
	pageName:'qualityScMonitorings',
	drivers:Ember.A(),
	domains:Ember.A(),
	questions:Ember.A(),
	monitoring:{
...
telenor.scMonitoringController = Ember.ObjectController.extend({
	need:['scMonitorings'],
    current_id:'',
