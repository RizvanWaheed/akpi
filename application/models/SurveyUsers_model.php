<?php
class SurveyUsers_model extends CI_Model {
    ...
    */
    ...
    function save_survey($id, $feedback = null) {
		...
		$data = array('survey_id' => $id, 'user_id' => $sess_data['data_logged_in']['id'], 'feedback' => $feedback);
		$insert = $this->db->insert('survey_users', $data);
