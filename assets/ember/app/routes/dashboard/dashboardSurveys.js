telenor.DashboardSurveysRoute = Ember.Route.extend(telenor.SecureRoute, Ember.PromiseProxyMixin, {
	controllerName:'dashboardSurveys',
	model:function(){ 
		//var _store = this.store;
		//console.log('Entered IN');
	   return this.store.find('surveys',{status:1});
	...
	// 		var _self = this;
	// 		var _controller = this.controllerFor('dashboardSurveys');
	// 		/*activities:{
	// 	    	monitoring_for_id:'',
	// 	    	email_driver_id:'',
	// 	    	email_reason_id:'',
