telenor.ReportsDaterangeRptagententeringsView = Ember.View.extend(telenor.AnimateView, { //telenor.MainView.extend({ 
	templateName: 'reports/daterange/rptagententerings',
