<?php
class AccalationLogs_model extends CI_Model {
	...
	public function save($accalation_log) {
		$insert = $this->db->insert('accalation_logs', $accalation_log);
		//return $this->db->insert_id()
		return $insert;
	}
	public function getAllAccalationLogs($accalation_id) {

		$this->db->select('id, accalation_id, remarks, created, state_id, created_by, (select name from complaint_states where id = state_id) state');
		$this->db->from('accalation_logs');
		$this->db->where('accalation_id', $accalation_id);
		/*$this->db->where('active', 'Y');*/
		//  $this->db->limit(35);
		$this->db->order_by('accalation_logs.created', 'desc');
		...
		return array('accalationLogs' => $result);
	}

	public function update_accalation_logs($data) {
		/*$id = $data['id'];
		unset($data['id']);*/
	...
	function getAccalationLogsReport($id) {
	...
	public function getAccalationLogsWorkCode($id = null, $fDate = null, $tDate = null, $sSearch = null, $iDisplayLength = null, $iDisplayStart = null, $iSortCol = null, $iSortDir = null, $fDate2 = null, $tDate2 = null, $entered = null, $closed = null, $type = null) {
		$whereClause = '';
		$search_sql = '';
		$amt = 10;
		$start = 0;
	...
	public function getAccalationLogsWorkCodeMsisdnImport($id = null, $fDate = null, $tDate = null, $fDate2 = null, $tDate2 = null, $entered = null, $closed = null, $type = null) {
		$whereClause = '';
		$search_sql = '';
		$amt = 10;
		$start = 0;
