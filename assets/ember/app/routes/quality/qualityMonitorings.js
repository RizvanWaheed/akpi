telenor.QualityMonitoringsRoute = Ember.Route.extend(telenor.SecureRoute, Ember.PromiseProxyMixin, {
	controllerName:'qualityMonitorings',
	model:function(){
	...
	actions: {
		createNewNode:function(obj, status, parent){
			var _self = this;
			var _controller = _self.controllerFor('qualityMonitorings');
		...
		save: function(monitoring){
			...
			var self = this;
			var controller = self.controllerFor('qualityMonitorings');
