telenor.QualityRendomizingsRoute = Ember.Route.extend(telenor.SecureRoute, {
	controllerName:'qualityRendomizings',

	renderTemplate:function(){
		this.render('quality/rendomizings');
	},
	/*beforeModel: function() {
		...
		if(Em.isEmpty(this.controllerFor("application").get('modules').findBy("link", "quality.rendomizings"))){
			this.transitionTo('/');
		}
    },*/
	model:function(){
	//	var storing = this.store.find('rendomizings');
	//	console.log(storing);
		return ;
	},
