telenor.UploadersAgentDataSheetsView = Ember.View.extend(telenor.AnimateView, { //telenor.MainView.extend({ 
	templateName: 'uploaders/agentDataSheets',
	didInsertElement: function () {
		Ember.$(":file").filestyle({
			buttonName: "btn-info btn-flat",
			buttonText: "",
			icon: true,
			buttonBefore: true
