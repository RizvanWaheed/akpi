telenor.ReportsDailyRptagententeringsController = Ember.ArrayController.extend({
	pageName:'reportsDailyRptagententerings',
...
/*telenor.ReportsDailyRptagententeringController = Ember.ObjectController.extend({
	need:['reportsDailyRptagententerings'],
